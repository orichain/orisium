...
static inline status_t orilink_serialize_heartbeat(const char *label, const orilink_heartbeat_t* payload, uint8_t* current_buffer, size_t buffer_size, size_t* offset) {
...
static inline status_t orilink_deserialize_heartbeat(const char *label, orilink_protocol_t *p, const uint8_t *buffer, size_t total_buffer_len, size_t *offset_ptr) {
