...
static inline status_t orilink_deserialize_hello1(const char *label, orilink_protocol_t *p, const uint8_t *buffer, size_t total_buffer_len, size_t *offset_ptr) {
    ...
    memcpy(payload->publickey1, cursor, KEM_PUBLICKEY_BYTES / 2);
