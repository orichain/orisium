#ifndef ORILINK_HELLO1_ACK_H
#define ORILINK_HELLO1_ACK_H
...
static inline status_t orilink_deserialize_hello1_ack(const char *label, orilink_protocol_t *p, const uint8_t *buffer, size_t total_buffer_len, size_t *offset_ptr) {
...
static inline orilink_protocol_t_status_t orilink_prepare_cmd_hello1_ack(
    const char *label, 
    oritlsf_pool_t *pool, 
    uint8_t inc_ctr, 
