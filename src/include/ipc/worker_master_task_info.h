...
static inline ipc_protocol_t_status_t ipc_prepare_cmd_worker_master_task_info(const char *label, worker_type_t wot, uint8_t index, uint8_t session_index, task_info_type_t flag) {
