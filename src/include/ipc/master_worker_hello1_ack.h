...
static inline ipc_protocol_t_status_t ipc_prepare_cmd_master_worker_hello1_ack(const char *label, worker_type_t wot, uint8_t index, uint8_t *nonce, uint8_t *kem_ciphertext) {
