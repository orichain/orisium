...
status_t add_master_sio_dc_session(const char *label, master_sio_dc_session_t **head, uint64_t id, uint8_t host_ip[]);
status_t delete_master_sio_dc_session(const char *label, master_sio_dc_session_t **head, uint64_t id);
master_sio_dc_session_t_status_t find_master_sio_dc_session(const char *label, master_sio_dc_session_t *head, uint64_t id);
master_sio_dc_session_t_status_t find_first_ratelimited_master_sio_dc_session(const char *label, master_sio_dc_session_t *head, uint8_t host_ip[]);
