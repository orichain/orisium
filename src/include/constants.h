...
//----------------------------------------------------------------------
#define NODE_HEARTBEATSEC_TIMEOUT 4
#define NODE_CHECK_HEALTHY_X 3
#define NODE_CHECK_HEALTHY NODE_CHECK_HEALTHY_X * NODE_HEARTBEATSEC_TIMEOUT
//----------------------------------------------------------------------
#define WORKER_HEARTBEATSEC_TIMEOUT 3
#define WORKER_CHECK_HEALTHY_X 3
#define WORKER_CHECK_HEALTHY WORKER_CHECK_HEALTHY_X * WORKER_HEARTBEATSEC_TIMEOUT
//----------------------------------------------------------------------
