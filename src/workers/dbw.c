...
//----------------------------------------------------------------------
                ...
                if (check_mac(dbw_ctx.worker.label, dbw_ctx.worker.kem_sharedsecret, ircvdi.r_ipc_raw_protocol_t->type, ircvdi.r_ipc_raw_protocol_t->recv_buffer, ircvdi.r_ipc_raw_protocol_t->n) != SUCCESS) {
				...
				if (ircvdi.r_ipc_raw_protocol_t->type == IPC_MASTER_WORKER_INFO) {
                    ipc_protocol_t_status_t deserialized_ircvdi = ipc_deserialize(dbw_ctx.worker.label,
                        dbw_ctx.worker.kem_sharedsecret, dbw_ctx.worker.remote_nonce, &dbw_ctx.worker.remote_ctr,
